...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
		<div class="col-lg-12">
			<a href="/admin.php?c=basic"><button type="button" class="btn btn-default"> 基本配置</button></a><a href="/admin.php?c=basic&a=cache"><button type="button" class="btn btn-primary" style="margin-left: 20px"> 缓存配置</button></a>
		</div>
		</div>
		<!-- /.row -->
		<div class="row">
