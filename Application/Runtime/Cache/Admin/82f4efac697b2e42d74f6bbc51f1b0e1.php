            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">请再次输入密码:</label>
                        <div class="col-sm-5">
                            <input type="password" name="password_re" class="form-control" id="inputname_re" placeholder="请再次填写密码"/> 
                        </div>
