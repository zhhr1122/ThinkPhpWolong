              ...
              <div class="col-sm-5">
                <select class="form-control" name="title_font_color">
                  <option value="">==请选择颜色==</option>
                       <?php if(is_array($tittleFontColor)): foreach($tittleFontColor as $key=>$color): ?><option value="<?php echo ($key); ?>"><?php echo ($color); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                    ...
                    <?php if(is_array($barMenus)): foreach($barMenus as $key=>$barMenu): ?><option value="<?php echo ($barMenu["menu_id"]); ?>"><?php echo ($barMenu["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
